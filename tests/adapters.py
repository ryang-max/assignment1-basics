...
def run_embedding(
    ...
    embedding.update_weight(weights)
...
def run_multihead_self_attention(
    ...
    return causal_mha(q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, in_features)
